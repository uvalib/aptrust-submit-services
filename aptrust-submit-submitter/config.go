...
type ServiceConfig struct {
	...
	APTAccessKey string // APT access credentials
	APTSecretKey string // APT access credentials
...
func LoadConfiguration() *ServiceConfig {
	...
	// outbound details
	cfg.APTBucket = ensureSetAndNonEmpty("APT_DEPOSIT_BUCKET")
	cfg.APTAccessKey = ensureSetAndNonEmpty("APT_ACCESS_KEY_ID")
	cfg.APTSecretKey = ensureSetAndNonEmpty("APT_SECRET_ACCESS_KEY")
	...
	// outbound details
	log.Printf("[CONFIG] APTBucket       = [%s]", cfg.APTBucket)
	log.Printf("[CONFIG] APTAccessKey    = [REDACTED]")
	log.Printf("[CONFIG] APTSecretKey    = [REDACTED]")
